...
import './contentsClassHistory.css'
...
const ContentsClass = () => {
  ...
  return (
    ...
    <ul id='ul'> 
        <li id='theLi'> 
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSJNFpJz3eDpE2vUSZFhR36ThBTmwk70Oy_sQ&usqp=CAU" alt="Math" /> <h2> History </h2>
        </li>
